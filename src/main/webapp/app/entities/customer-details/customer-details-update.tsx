  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="pharmaApp.customerDetails.home.createOrEditLabel" data-cy="CustomerDetailsCreateUpdateHeading">
            <Translate contentKey="pharmaApp.customerDetails.home.createOrEditLabel">Create or edit a CustomerDetails</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('pharmaApp.customerDetails.gender')}
              ...
              >
                {genderValues.map(gender => (
                  <option value={gender} key={gender}>
                    {translate('pharmaApp.Gender.' + gender)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('pharmaApp.customerDetails.phone')}
              ...
              />
              <ValidatedField
                label={translate('pharmaApp.customerDetails.addressLine1')}
              ...
              />
              <ValidatedField
                label={translate('pharmaApp.customerDetails.addressLine2')}
              ...
              />
              <ValidatedField
                label={translate('pharmaApp.customerDetails.city')}
              ...
              />
              <ValidatedField
                label={translate('pharmaApp.customerDetails.country')}
              ...
              <ValidatedField
                ...
                name="user"
                data-cy="user"
                label={translate('pharmaApp.customerDetails.user')}
                type="select"
                required
              >
                <option value="" key="0" />
