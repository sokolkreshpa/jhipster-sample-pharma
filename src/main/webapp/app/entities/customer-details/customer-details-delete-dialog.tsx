...
export const CustomerDetailsDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="pharmaApp.customerDetails.delete.question">
        <Translate contentKey="pharmaApp.customerDetails.delete.question" interpolate={{ id: customerDetailsEntity.id }}>
