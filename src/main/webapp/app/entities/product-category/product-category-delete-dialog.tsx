...
export const ProductCategoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="pharmaApp.productCategory.delete.question">
        <Translate contentKey="pharmaApp.productCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
