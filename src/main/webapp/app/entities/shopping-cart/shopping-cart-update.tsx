  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="pharmaApp.shoppingCart.home.createOrEditLabel" data-cy="ShoppingCartCreateUpdateHeading">
            <Translate contentKey="pharmaApp.shoppingCart.home.createOrEditLabel">Create or edit a ShoppingCart</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('pharmaApp.shoppingCart.placedDate')}
              ...
              />
              <ValidatedField
                label={translate('pharmaApp.shoppingCart.status')}
              ...
              >
                {orderStatusValues.map(orderStatus => (
                  <option value={orderStatus} key={orderStatus}>
                    {translate('pharmaApp.OrderStatus.' + orderStatus)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('pharmaApp.shoppingCart.totalPrice')}
              ...
              />
              <ValidatedField
                label={translate('pharmaApp.shoppingCart.paymentMethod')}
              ...
              >
                {paymentMethodValues.map(paymentMethod => (
                  <option value={paymentMethod} key={paymentMethod}>
                    {translate('pharmaApp.PaymentMethod.' + paymentMethod)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('pharmaApp.shoppingCart.paymentReference')}
              ...
              <ValidatedField
                ...
                label={translate('pharmaApp.shoppingCart.customerDetails')}
                type="select"
                required
              >
                <option value="" key="0" />
