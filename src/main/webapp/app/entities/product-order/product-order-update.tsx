  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="pharmaApp.productOrder.home.createOrEditLabel" data-cy="ProductOrderCreateUpdateHeading">
            <Translate contentKey="pharmaApp.productOrder.home.createOrEditLabel">Create or edit a ProductOrder</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('pharmaApp.productOrder.quantity')}
              ...
              />
              <ValidatedField
                label={translate('pharmaApp.productOrder.totalPrice')}
              ...
              <ValidatedField
                ...
                name="product"
                data-cy="product"
                label={translate('pharmaApp.productOrder.product')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="cart"
                data-cy="cart"
                label={translate('pharmaApp.productOrder.cart')}
                type="select"
                required
              >
                <option value="" key="0" />
