  ...
  return (
    <div>
      <h2 id="product-order-heading" data-cy="ProductOrderHeading">
        <Translate contentKey="pharmaApp.productOrder.home.title">Product Orders</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="pharmaApp.productOrder.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/product-order/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="pharmaApp.productOrder.home.createLabel">Create new Product Order</Translate>
          </Link>
        </div>
      </h2>
        ...
        {productOrderList && productOrderList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="pharmaApp.productOrder.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="pharmaApp.productOrder.quantity">Quantity</Translate>
                </th>
                <th>
                  <Translate contentKey="pharmaApp.productOrder.totalPrice">Total Price</Translate>
                </th>
                <th>
                  <Translate contentKey="pharmaApp.productOrder.product">Product</Translate>
                </th>
                <th>
                  <Translate contentKey="pharmaApp.productOrder.cart">Cart</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="pharmaApp.productOrder.home.notFound">No Product Orders found</Translate>
            </div>
          )
        )}
      </div>
