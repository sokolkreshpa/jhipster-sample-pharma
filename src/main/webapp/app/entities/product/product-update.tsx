  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="pharmaApp.product.home.createOrEditLabel" data-cy="ProductCreateUpdateHeading">
            <Translate contentKey="pharmaApp.product.home.createOrEditLabel">Create or edit a Product</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('pharmaApp.product.name')}
                id="product-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('pharmaApp.product.description')}
              ...
              />
              <ValidatedField
                label={translate('pharmaApp.product.price')}
                id="product-price"
                name="price"
                data-cy="price"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('pharmaApp.product.productSize')}
              ...
              >
                {sizeValues.map(size => (
                  <option value={size} key={size}>
                    {translate('pharmaApp.Size.' + size)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedBlobField
                label={translate('pharmaApp.product.image')}
                id="product-image"
                name="image"
                data-cy="image"
                isImage
              ...
              <ValidatedField
                ...
                label={translate('pharmaApp.product.productCategory')}
                type="select"
                required
              >
                <option value="" key="0" />
